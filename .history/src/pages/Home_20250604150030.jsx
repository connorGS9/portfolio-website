        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div ref={ctaRef} className="about-text">
              <p>
                I'm a passionate backend developer with a keen interest in building robust server-side systems 
              ...
              <p>
                When I'm not coding, you can find me participating in competitive programming contests 
                or exploring new technologies to expand my skill set. I believe in writing clean, 
          ...
          <div className="hero-image">
            <div className="image-container">
              <img src="/path-to-your-image.jpg" alt="Connor" className="profile-image" />
